...
private:
  ...
  void     equalityFactoring(std::ostream &out, SortMap &conclSorts, Clause *concl, const InferenceRecorder::InferenceInformation* info);
  ...
  std::set<unsigned> clausifiedUnits;
